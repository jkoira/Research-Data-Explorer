...
* The user can select one or more classifications for the metadata (e.g., data access, data type, scientific field). Possible classifications are stored in the database.
* The user can add comments to the metadata of their own datasets as well as those added by other users. Comments can describe, for example, the use cases of the data or assessments of the data quality.
